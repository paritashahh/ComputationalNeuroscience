...
goffer_type = [(25, 75), (25, 100), (50, 10), (50, 100), (75, 10), (75, 25), (100, 10), (100, 25), (100, 50)]
loffer_type = [(-25, -75), (-25, -100), (-50, -10), (-50, -100), (-75, -10), (-75, -25), (-100, -10), (-100, -25), (-100, -50)]
...
avg_accept = []
avg_rts = []
for i in range(len(goffer_type)):
    NDT = 868
    d_var = 0
    wself  = 0.006
    wother = 0.001
    ...
    p1 = 1
    p2 = 1
    pself = goffer_type[i][0]
    pother = goffer_type[i][1]
    base = -50
    s = 5
    avg_int1 = 0.
    avg_int2 = 0.
...
for i in range(len(loffer_type)):
    NDT = 868
    d_var = 0
    wself  = 0.006
    wother = 0.001
    ...
    p1 = 1
    p2 = 1
    pself = loffer_type[i][0]
    pother = loffer_type[i][1]
    base = 50
    s = 20
    avg_int1 = 0.
    avg_int2 = 0.
...
print("Social Distance Generousness: ", generousness)
domain = ['Gain Domain', 'Loss Domain']
plt.bar(domain,generousness, color=['gray', 'black'])
plt.ylim(0, 1)
plt.ylabel('Average Generosity')
plt.xlabel('Domain')
plt.title("Model Implications for Domain Specific Generosity with Social Distance Factor") 
plt.savefig('socialdistancegenerosity.png', bbox_inches='tight')
plt.show()
...
print("Regular Generousness: ", generousness)
domain = ['Gain Domain', 'Loss Domain']
plt.bar(domain,generousness, color=['gray', 'black'])
plt.ylim(0, 1)
plt.ylabel('Average Generosity')
plt.xlabel('Domain')
plt.title("Model Implications for Domain Specific Generosity") 
plt.savefig('generosity.png', bbox_inches='tight')
plt.show()
